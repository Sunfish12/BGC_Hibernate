...
public class BoardGamesDAOHibernate implements BoardGamesDAO_Interface {
	...
	public BoardGames findByPrimeKey(Integer boardGamesId) {
		...
		try {
			...
			boardGames = (BoardGames) session.get(BoardGames.class,
					boardGamesId);
	...
	public static void main(String[] args) {
		...
		BoardGameKindDAO_Interface bgkdao = new BoardGameKindDAOHibernate();
