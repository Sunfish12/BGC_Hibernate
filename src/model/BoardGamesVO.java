...
public class BoardGamesVO implements java.io.Serializable {
	...
	private Set<BoardGames_ImageVO> boardGamesImages = new HashSet<BoardGames_ImageVO>(
			0);
	...
	public Set<BoardGames_ImageVO> getBoardGamesImages() {
		return this.boardGamesImages;
	}

	public void setBoardGamesImages(Set<BoardGames_ImageVO> boardGamesImages) {
		this.boardGamesImages = boardGamesImages;
	}
